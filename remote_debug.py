...
# use "import remote_debug" somewhere in your code as an alternative to "python -m pdb myscript...",
...
def info(type, value, tb):
    ...
    #     + '8083489586@vtext.com < /dev/null'.format(j=os.environ.get('SLURM_JOBID'), h=hostname, p=port)
    # )
...
try:
    ...
    print("ERROR: You must install remote_pdb (pip install remote-pdb) to use the remote_debug module.")
